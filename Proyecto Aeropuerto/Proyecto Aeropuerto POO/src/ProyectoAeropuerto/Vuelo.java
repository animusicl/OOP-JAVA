...
public class Vuelo {
  ...
  public void insertarPasajeros (Pasajero pasajero) {
      ...
      listaPasajeros[numActualPasajeros] = pasajero; //iterador
      numActualPasajeros++;
    ...
    public Pasajero getPasajero (String pasaporte) {
     ...
     while ((!encontrado) && (i<listaPasajeros.length)){ //!encontrado es lo mismo que == false
         if (pasaporte.equals(listaPasajeros[i].getPasaporte())); { //pasaporte == listaPasajeros[i]
         encontrado = true;
